	...
	public class MyConfig
	{
		...
		public static class Common
		{
			...
			public Common(ForgeConfigSpec.Builder builder)
			{
				...
				oddsSpawnerJustZombie = builder
						.comment("Odds Spawner ZV is just a Zombie")						
						.translation(Main.MODID + ".config." + "oddsSpawnerJustZombie")
						.defineInRange("oddsSpawnerJustZombie", () -> 100.0, 0.0, 100.0 );
				
				oddsNaturalJustZombie = builder
						.comment("Odds Natural ZV is just a Zombie")						
